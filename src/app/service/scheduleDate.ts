...
export const SEASON_SCHEDULE:Schedule[]=[
    ...
    AwayTeam:'Persipon',HomeScore:2,AwayScore:4,RefName:'Parto',
    notes:'Pertandingan ada Kerusuhan'},
    {id:4,playingDate:new Date(2021,8,14),HomeTeam: 'RRQ',
    AwayTeam:'PERSIB',HomeScore:2,AwayScore:4,RefName:'Parto',
    notes:'Pertandingan 3 kartu merah dari PERSIB'},
    {id:5,playingDate:new Date(2021,8,15),HomeTeam: 'PERSIS SOLO',
    AwayTeam:'PERIB',HomeScore:2,AwayScore:3,RefName:'Parto',
